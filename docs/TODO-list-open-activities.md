...
- [ ] Implement delete functionality for individual photos and their associated data in the history list.
- [ ] Implement copy to clipboard functionality for individual photos and their associated data in the history list.
...
- [ ] Store and display creation timestamps for extracted text and photo metadata, and last-modified timestamps for photo metadata.
